...
<html lang="ja" dir="ltr">
  ...
  <body style="margin: 10% 20%;">
      ...
      <form action="math-signup-check.php" method="post" id="sign_up" name="su">
          ...
          <div class="form-group">
            <label for="pass1">パスワード　(必須)</label>
          ...
          <div class="form-group">
            <label for="pass2">確認のためもう一度入力してください　(必須)</label>
            <input type="password" class="form-control" id="pass2" name="pass2" maxlength="10">
            <div class="error" id="error_pass2" style="display:none;">パスワードが一致していません</div>
          </div>
      ...
      <button value="送信" class="btn btn-primary mb-2">登録する</button>
        </div>
